...
- (id)init
{
    return [self initWithNibName:@"InfColorPickerView" bundle:nil];
}
...
- (id) initWithNibName: (NSString*) nibNameOrNil bundle: (NSBundle*) nibBundleOrNil
{
	...
	if( self ) {
        ...
        self.sourceColor = [[UIApplication sharedApplication].keyWindow backgroundColor];
	}
...
- (void)viewWillDisappear:(BOOL)animated
{
	...
	if (self.navigationController)
        [[UIApplication sharedApplication].keyWindow setBackgroundColor:self.resultColor];
